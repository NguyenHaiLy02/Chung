        ...
        <div class="product-info">
            ...
            <div>
                ...
                <input type="number" id="quantity" name="quantity" min="1" max="{{ $sanPham->soLuongTonKho }}"
                    value="{{ old('quantity', 1) }}" style="width: 60px; margin-left: 10px; padding: 5px; text-align: center;">
            </div>

            <div style="display: flex">
                <form action="{{ route('order.create', ['sanPhamId' => $sanPham->maSanPham]) }}" method="GET">
                    @csrf
                    <input type="hidden" name="quantity" id="hiddenQuantity" value="{{ old('quantity', 1) }}">
